...
#-- have valid consent or are died and don't have any outstnading queries
#-- include everyone regardless of whether we have genome or not or clinical data or not
